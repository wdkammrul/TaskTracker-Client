         ...
         <br /><br /><b></b>
            <form onSubmit={handleLogin} className="w-11/12 md:w-3/4 lg:w-1/2 mx-auto bg-slate-800 rounded-lg p-10 mt-10">
                <div className="form-control">
                    ...
                    <button onClick={signInUsingPopup} className="mb-10 mt-6 m-auto btn text-blue-600  btn-outline btn-primary uppercase">Log in with Google </button>
                ...
                <div className="form-control mt-10 ">
                    <button className="btn rounded-full bg-blue-600 btn-primary mx-auto w-[220px] text-white">Log In</button>

                    <div className="flex my-8 ">
                        <p className="text-center mx-auto">New here ? Please <Link to='/register'> <span className="underline font-extrabold text-blue-500 text-2xl ">Register</span></Link></p>
