...
const Register = () => {
    ...
    const handleRegisterBtn = (e) => {
        ...
        registerUser(email, password)
            .then(res => toast('Congratulations! You are New Member', res))
        ...
        <div>
            ...
            <form onSubmit={handleRegisterBtn} className="w-11/12 md:w-3/4 lg:w-1/2 mx-auto bg-slate-800 rounded-lg p-10 mt-10">
                ...
                <div className="form-control mt-6 ">
                    <button className="btn bg-blue-600 btn-primary rounded-full mt-3 mx-auto w-[220px] text-white">Register</button>

                    <div className="flex my-8 ">
                        <p className="text-center mx-auto">Already Have an account ? <Link to='/login'> <span className="underline font-extrabold text-blue-600 text-2xl">Log In</span> </Link></p>
