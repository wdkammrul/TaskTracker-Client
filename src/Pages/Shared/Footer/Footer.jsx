...
const Footer = () => {
    return (
        <div className="overflow-x-hidden">
            <footer className="footer mb-10 mt-32 p-20 bg-slate-900 text-base-content rounded-lg w-[400px] md:w-[740px] lg:w-full mx-auto">
                <nav className="space-y-4 ">
                    ...
                    <div className="lg:flex justify-center items-center gap-3">
                        <img className="rounded-full w-10 h-8 " src="https://i.ibb.co/M2PmVCs/images.png" alt="" />
                        <Link to='/' className="text-3xl ml-2 uppercase text-blue-500"><span className="text-4xl">T</span>askTracker</Link>
                    </div>


                    <div className="flex flex-col text-xl font-bold">
                        <a className="link link-hover">82, Segunbagicha, Dhaka 1000</a>
                        <a className="link link-hover mt-4">Email: wdkammrul@gmail.com</a>
                        <a className="link link-hover mt-4">Phone: 01710-510464 </a>
                    </div>
            ...
            <Link to="/" className="flex justify-center gap-3 text-white normal-case text-xl md:text-2xl mb-10">Copyright © 2023 - All right reserved by <span className="text-2xl md:text-2xl font-extrabold uppercase text-blue-500">TaskTracker</span></Link>
