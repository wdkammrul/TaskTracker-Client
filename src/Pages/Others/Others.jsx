            ...
            <div className='max-w-screen-xl mx-auto my-20'>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-4'>
                    ...
                    <div data-aos="flip-left"
                        ...
                        <h2 className='text-2xl font-bold text-white my-2'>Unlimited Income</h2>
                        <p className='text-white mt-4'>TaskTracker project assures endless earning options and innovation. Join for limitless financial gains and explore lucrative opportunities.</p>
